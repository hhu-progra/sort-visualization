 ...
 *       images and strings
 *
 * taken from https://introcs.cs.princeton.edu/java/stdlib/, released under the GNU General Public License, version 3 (GPLv3)
 ******************************************************************************/
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
        try {
            ...
            System.err.println("Error: Could not create JFrame. This is okay if running in the CI. If you see this on your regular computer, please ask for help.");
        }
    ...
    @SuppressWarnings("deprecation") // there is an updated version of StdDraw, but the newer call does not work with Java <10
